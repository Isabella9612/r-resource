...
airlines <- read.csv("C:/Users/Isabella/Documents/MBA FGV/03.Inferência Estatística/Trabalho Em Grupo/Bases/nyc_airlines.csv", 
                         head = T, sep = ",", stringsAsFactors = TRUE)

airports <- read.csv("C:/Users/Isabella/Documents/MBA FGV/03.Inferência Estatística/Trabalho Em Grupo/Bases/nyc_airports.csv", 
                         head = T, sep = ",", stringsAsFactors = TRUE)

flights <- read.csv("C:/Users/Isabella/Documents/MBA FGV/03.Inferência Estatística/Trabalho Em Grupo/Bases/nyc_flights.csv", 
                         head = T, sep = ",", stringsAsFactors = TRUE)

planes <- read.csv("C:/Users/Isabella/Documents/MBA FGV/03.Inferência Estatística/Trabalho Em Grupo/Bases/nyc_planes.csv", 
                    head = T, sep = ",", stringsAsFactors = TRUE)

weather <- read.csv("C:/Users/Isabella/Documents/MBA FGV/03.Inferência Estatística/Trabalho Em Grupo/Bases/nyc_weather.csv", 
                   head = T, sep = ",", stringsAsFactors = TRUE)
